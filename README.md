...
## Downloading Frames
`download_script.sh` will download the frames from the relevent participants P08, P01 and P22 into the below directory structure. Unless an argument is specfied, the directory structure will be created in `"$HOME/Downloads/EPIC_KITCHENS_UDA"`.
